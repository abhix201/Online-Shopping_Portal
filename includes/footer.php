...
<h3>Shopping Portal</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> For more information please contact us on the links given below or check the information tab for personal mobile numbers.</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>(+91) 8830121428 (ABHIJEET GUPTA)<br>(+91) 8806841193(MRUDUL GAIDANE)</p>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">info@abhix201.com</a></span>
                </div>
            </li>
